/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; (function() {
  ...
  module.exports = GraphDatabase = (function() {
    ...
    GraphDatabase.prototype.getNodeIndexes = function GraphDatabase_prototype_getNodeIndexes__14(_) { var response, services, url, __this = this; var __frame = { name: "GraphDatabase_prototype_getNodeIndexes__14", line: 233 }; return __func(_, this, arguments, GraphDatabase_prototype_getNodeIndexes__14, 0, __frame, function __$GraphDatabase_prototype_getNodeIndexes__14() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GraphDatabase_prototype_getNodeIndexes__14() {


              return __this.getServices(__cb(_, __frame, 3, 19, function ___(__0, __1) { services = __1;
                url = (("" + services.node_index) + "/");
                return __this._request.get(url, __cb(_, __frame, 5, 19, function ___(__0, __2) { response = __2;
                  if (((response.statusCode !== status.OK) && (response.statusCode !== status.NO_CONTENT))) {
                    return _(response); } ;

                  return _(null, response.body); }, true)); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$GraphDatabase_prototype_getNodeIndexes__14() { if (error) {

                return _(adjustError(error)); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); };



    GraphDatabase.prototype.createNodeIndex = function GraphDatabase_prototype_createNodeIndex__15(index, _) { var response, services, __this = this; var __frame = { name: "GraphDatabase_prototype_createNodeIndex__15", line: 248 }; return __func(_, this, arguments, GraphDatabase_prototype_createNodeIndex__15, 1, __frame, function __$GraphDatabase_prototype_createNodeIndex__15() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GraphDatabase_prototype_createNodeIndex__15() {
              ...
              return __this.getServices(__cb(_, __frame, 3, 19, function ___(__0, __1) { services = __1;
                return __this._request.post({
                  ...
                  return _(null, response.body); }, true)); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$GraphDatabase_prototype_createNodeIndex__15() { if (error) {

                return _(adjustError(error)); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); };



    GraphDatabase.prototype.deleteNodeIndex = function GraphDatabase_prototype_deleteNodeIndex__16(index, _) { var response, services, url, __this = this; var __frame = { name: "GraphDatabase_prototype_deleteNodeIndex__16", line: 267 }; return __func(_, this, arguments, GraphDatabase_prototype_deleteNodeIndex__16, 1, __frame, function __$GraphDatabase_prototype_deleteNodeIndex__16() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GraphDatabase_prototype_deleteNodeIndex__16() {
              ...
              return __this.getServices(__cb(_, __frame, 3, 19, function ___(__0, __1) { services = __1;
                ...
                return __this._request.del(url, __cb(_, __frame, 5, 19, function ___(__0, __2) { response = __2;
                  ...
                  return _(null, null); }, true)); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$GraphDatabase_prototype_deleteNodeIndex__16() { if (error) {
    ...
    GraphDatabase.prototype.deleteRelationshipIndex = function GraphDatabase_prototype_deleteRelationshipIndex__19(index, _) { var response, services, url, __this = this; var __frame = { name: "GraphDatabase_prototype_deleteRelationshipIndex__19", line: 316 }; return __func(_, this, arguments, GraphDatabase_prototype_deleteRelationshipIndex__19, 1, __frame, function __$GraphDatabase_prototype_deleteRelationshipIndex__19() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GraphDatabase_prototype_deleteRelationshipIndex__19() {
              ...
              return __this.getServices(__cb(_, __frame, 3, 19, function ___(__0, __1) { services = __1;
                ...
                return __this._request.del(url, __cb(_, __frame, 5, 19, function ___(__0, __2) { response = __2;
                  ...
                  return _(null, null); }, true)); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$GraphDatabase_prototype_deleteRelationshipIndex__19() { if (error) {
