/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch,__apply=__rt.__apply; (function() {
  ...
  module.exports = Node = (function(_super) {
    ...
    Node.prototype._createRelationship = function Node_prototype__createRelationship__7(from, to, type, data, _) { var createRelationshipURL, exception, message, otherNodeURL, response, _ref, __this = this; var __frame = { name: "Node_prototype__createRelationship__7", line: 184 }; return __func(_, this, arguments, Node_prototype__createRelationship__7, 4, __frame, function __$Node_prototype__createRelationship__7() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype__createRelationship__7() {


              createRelationshipURL = from._data["create_relationship"];
              otherNodeURL = to.self; return (function __$Node_prototype__createRelationship__7(__then) {
                if ((((createRelationshipURL != null)) && otherNodeURL)) {
                  return __this._request.post({
                    ...
                    json: {
                      to: otherNodeURL,
                      data: data,
                      type: type } }, __cb(_, __frame, 6, 21, function ___(__0, __3) { response = __3; return (function __$Node_prototype__createRelationship__7(__then) {


                      if ((response.statusCode !== status.CREATED)) {
                        _ref = (response.body || { }), message = _ref.message, exception = _ref.exception; return (function __$Node_prototype__createRelationship__7(_) {
                          var __2 = message; if (__2) { return _(null, __2); } ; return (function __$Node_prototype__createRelationship__7(_) { var __3 = exception; if (__3) { return _(null, __3); } ;
                            ...
                            return (function __1(_) { switch (response.statusCode) { case status.BAD_REQUEST: return _(null, ((((((("Invalid createRelationship: " + from.id) + " ") + type) + " ") + to.id) + " w/ data: ") + (JSON.stringify(data)))); case status.CONFLICT: return _(null, "\"to\" node, or the node specified by the URI not found"); default: return _(response); }; _(); })(__cb(_, __frame, 25, 47, _, true)); })(__cb(_, __frame, -183, 7, function ___(__0, __5) { var __4 = (message = __5); return _(null, __4); }, true)); })(__cb(_, __frame, -183, 7, function __$Node_prototype__createRelationship__7() {
                          return _(new Error(message)); }, true)); } else { __then(); } ; })(function __$Node_prototype__createRelationship__7() {

                      return _(null, new Relationship(__this.db, response.body, from, to)); }); }, true)); } else {

                  return _(new Error("Failed to create relationship")); } ; })(__then); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype__createRelationship__7() { if (error) {
    ...
    Node.prototype._getRelationships = function Node_prototype__getRelationships__8(direction, type, _) { var prefix, relationshipsURL, resp, types, _this, __this = this; var __frame = { name: "Node_prototype__getRelationships__8", line: 221 }; return __func(_, this, arguments, Node_prototype__getRelationships__8, 2, __frame, function __$Node_prototype__getRelationships__8() { _this = __this;


        types = null;
        if ((type != null)) {
          types = ((type instanceof Array) ? type : [type,]); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype__getRelationships__8() {
              ...
              return __this._request.get(relationshipsURL, __cb(_, __frame, 17, 15, function ___(__0, __1) { resp = __1;
                ...
                return _(null, resp.body.map(function(data) {
                  if ((_this.self === data.start)) {
                    ...
                    return new Relationship(_this.db, data, null, _this); } ; })); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype__getRelationships__8() { if (error) {
    ...
    Node.prototype.getRelationships = function Node_prototype_getRelationships__9(type, _) { var __this = this; var __frame = { name: "Node_prototype_getRelationships__9", line: 257 }; return __func(_, this, arguments, Node_prototype_getRelationships__9, 1, __frame, function __$Node_prototype_getRelationships__9() {
        return __this.all(type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.outgoing = function Node_prototype_outgoing__10(type, _) { var __this = this; var __frame = { name: "Node_prototype_outgoing__10", line: 261 }; return __func(_, this, arguments, Node_prototype_outgoing__10, 1, __frame, function __$Node_prototype_outgoing__10() {
        return __this._getRelationships("outgoing", type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.incoming = function Node_prototype_incoming__11(type, _) { var __this = this; var __frame = { name: "Node_prototype_incoming__11", line: 265 }; return __func(_, this, arguments, Node_prototype_incoming__11, 1, __frame, function __$Node_prototype_incoming__11() {
        return __this._getRelationships("incoming", type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.all = function Node_prototype_all__12(type, _) { var __this = this; var __frame = { name: "Node_prototype_all__12", line: 269 }; return __func(_, this, arguments, Node_prototype_all__12, 1, __frame, function __$Node_prototype_all__12() {
        return __this._getRelationships("all", type, __cb(_, __frame, 1, 13, _, true)); }); };


    Node.prototype.getRelationshipNodes = function Node_prototype_getRelationshipNodes__13(rels, _) { var resp, traverseURL, _ref, _ref1, _ref2, _this, __this = this; var __frame = { name: "Node_prototype_getRelationshipNodes__13", line: 273 }; return __func(_, this, arguments, Node_prototype_getRelationshipNodes__13, 1, __frame, function __$Node_prototype_getRelationshipNodes__13() { _this = __this;
        ...
        rels = ((rels instanceof Array) ? rels : [rels,]); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype_getRelationshipNodes__13() {
              ...
              return __this._request.post({
                ...
                return _(null, resp.body.map(function(data) {
                  return new Node(_this.db, data); })); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype_getRelationshipNodes__13() { if (error) {
    ...
    Node.prototype.path = function Node_prototype_path__14(to, type, direction, maxDepth, algorithm, _) { var data, end, length, nodes, pathURL, relationships, res, start, _this, __this = this; var __frame = { name: "Node_prototype_path__14", line: 311 }; return __func(_, this, arguments, Node_prototype_path__14, 5, __frame, function __$Node_prototype_path__14() { _this = __this;
        ...
        if ((algorithm == null)) {
          algorithm = "shortestPath"; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Node_prototype_path__14() {
              ...
              return __this._request.post({
                ...
                return _(null, new Path(start, end, length, nodes, relationships)); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Node_prototype_path__14() { if (error) {
