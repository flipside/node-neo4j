/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; (function() {
  ...
  module.exports = Relationship = (function(_super) {
    ...
    Relationship.prototype.unindex = function Relationship_prototype_unindex__3(index, key, value, _) { var encodedKey, encodedValue, response, services, url, __this = this; var __frame = { name: "Relationship_prototype_unindex__3", line: 139 }; return __func(_, this, arguments, Relationship_prototype_unindex__3, 3, __frame, function __$Relationship_prototype_unindex__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Relationship_prototype_unindex__3() {


              if (!__this.exists) {
                return _(new Error("Relationship must exist before unindexing properties")); } ;
              ...
              return __this.db.getServices(__cb(_, __frame, 6, 19, function ___(__0, __1) { services = __1;
                if (key) {
                  ...
                  if (value) {
                    encodedValue = encodeURIComponent(value);
                    url = ((((((((("" + services.relationship_index) + "/") + index) + "/") + encodedKey) + "/") + encodedValue) + "/") + __this.id); }
                   else {
                    url = ((((((("" + services.relationship_index) + "/") + index) + "/") + encodedKey) + "/") + __this.id); } ; }

                 else {
                  url = ((((("" + services.relationship_index) + "/") + index) + "/") + __this.id); } ;

                return __this._request.del(url, __cb(_, __frame, 18, 19, function ___(__0, __2) { response = __2;
                  if ((response.statusCode !== status.NO_CONTENT)) {
                    return _(response); } ; __then(); }, true)); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Relationship_prototype_unindex__3() { if (error) {
